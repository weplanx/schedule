...
func init() {
	proto.RegisterType((*NoParameter)(nil), "ScheduleMicroservice.NoParameter")
	proto.RegisterType((*Response)(nil), "ScheduleMicroservice.Response")
	proto.RegisterType((*EntryOption)(nil), "ScheduleMicroservice.EntryOption")
	proto.RegisterType((*EntryOptionWithTime)(nil), "ScheduleMicroservice.EntryOptionWithTime")
	proto.RegisterType((*Information)(nil), "ScheduleMicroservice.Information")
	proto.RegisterMapType((map[string]*EntryOptionWithTime)(nil), "ScheduleMicroservice.Information.EntriesEntry")
	proto.RegisterType((*GetParameter)(nil), "ScheduleMicroservice.GetParameter")
	proto.RegisterType((*GetResponse)(nil), "ScheduleMicroservice.GetResponse")
	proto.RegisterType((*ListsParameter)(nil), "ScheduleMicroservice.ListsParameter")
	proto.RegisterType((*ListsResponse)(nil), "ScheduleMicroservice.ListsResponse")
	proto.RegisterType((*AllResponse)(nil), "ScheduleMicroservice.AllResponse")
	proto.RegisterType((*PutParameter)(nil), "ScheduleMicroservice.PutParameter")
	proto.RegisterMapType((map[string]*EntryOption)(nil), "ScheduleMicroservice.PutParameter.EntriesEntry")
	proto.RegisterType((*DeleteParameter)(nil), "ScheduleMicroservice.DeleteParameter")
	proto.RegisterType((*RunningParameter)(nil), "ScheduleMicroservice.RunningParameter")
}
...
var fileDescriptor_367072455c71aedc = []byte{
	...
	,
}
...
func (c *routerClient) Get(ctx context.Context, in *GetParameter, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/ScheduleMicroservice.Router/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Lists(ctx context.Context, in *ListsParameter, opts ...grpc.CallOption) (*ListsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ScheduleMicroservice.Router/Lists", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) All(ctx context.Context, in *NoParameter, opts ...grpc.CallOption) (*AllResponse, error) {
	out := new(AllResponse)
	err := c.cc.Invoke(ctx, "/ScheduleMicroservice.Router/All", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Put(ctx context.Context, in *PutParameter, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ScheduleMicroservice.Router/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Delete(ctx context.Context, in *DeleteParameter, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ScheduleMicroservice.Router/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Running(ctx context.Context, in *RunningParameter, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ScheduleMicroservice.Router/Running", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Router_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ScheduleMicroservice.Router/Get",
	}
...
func _Router_Lists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ScheduleMicroservice.Router/Lists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_All_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ScheduleMicroservice.Router/All",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ScheduleMicroservice.Router/Put",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ScheduleMicroservice.Router/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_Running_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ScheduleMicroservice.Router/Running",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Router_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ScheduleMicroservice.Router",
